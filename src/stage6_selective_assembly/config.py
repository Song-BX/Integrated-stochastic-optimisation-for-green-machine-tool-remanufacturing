"""Configuration for Stage 6 selective-assembly stochastic MILP runs."""
...
class Stage6Config:
    """Runtime configuration for the Stage 6 selective-assembly model."""

    raw_dir: Path = Path("data/raw")
    stage1_report: Path = Path("data/processed/stage1/validation_report.json")
    processed_dir: Path = Path("data/processed/stage6")
    results_dir: Path = Path("data/results/stage6")
    ...
    def resolved(self, root: Path) -> "Stage6Config":
